    ...
    <div>
      {
        homePageContent && (
          <div className='text-center mb-10 max-w-6xl mx-auto py-10'>
            <h1 className='text-4xl font-extrabold mb-4 bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 bg-clip-text text-transparent'>{homePageContent.title}</h1>
            <div
